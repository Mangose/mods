...
| ----------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Container` | Flex layout              | `direction`: `string`, default `row`, required: no — flex direction.<br>`justify`: `string`, default `flex-start`, required: no — `justify-content` value.<br>`align`: `string`, default `stretch`, required: no — `align-items` value.<br>`alignContent`: `string`, default `undefined`, required: no — `align-content` for multi-line flex.<br>`wrap`: `boolean \| string`, default `false`, required: no — `true` -> `wrap`, string passthru.<br>`gap`: `number \| string`, default `undefined`, required: no — gap between items.<br>`rowGap`: `number \| string`, default `undefined`, required: no — row gap override.<br>`columnGap`: `number \| string`, default `undefined`, required: no — column gap override.<br>`inline`: `boolean`, default `false`, required: no — render as `inline-flex`.<br>`grow`: `number \| string`, default `undefined`, required: no — `flex-grow` value.<br>`shrink`: `number \| string`, default `undefined`, required: no — `flex-shrink` value.<br>`basis`: `number \| string`, default `undefined`, required: no — `flex-basis` value.<br>`padding`: `number \| string`, default `3`, required: no — inner spacing.<br>`margin`: `number \| string`, default `undefined`, required: no — outer spacing.<br>`scrollable`: `boolean`, default `false`, required: no — sets `overflow: auto`.<br>`height`: `number \| string`, default `undefined`, required: no — sets height/min/max.<br>`width`: `number \| string`, default `undefined`, required: no — sets width/min/max. |
| `Fragment`  | Render without a wrapper | none                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `Spacer`    | Fixed spacer             | `size`: `number \| string`, default `1`, required: no — square spacer size.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `Divider`   | Separator line           | `direction`: `string`, default `horizontal`, required: no — `horizontal` or `vertical`.<br>`thickness`: `number \| string`, default `1`, required: no — line thickness.<br>`length`: `number \| string`, default `100%`, required: no — line length.<br>`margin`: `number \| string`, default `undefined`, required: no — outer spacing.<br>`color`: `string`, default `rgba(0, 0, 0, 0.1)`, required: no — line color.                                                                                                                                                                                                                                                                                                                                                       |
